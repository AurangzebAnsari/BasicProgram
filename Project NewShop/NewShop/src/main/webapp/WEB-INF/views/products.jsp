					...
					<div class="container">
						<div class="product-agileinfo-grids w3l">
							<div class="col-md-3 product-agileinfo-grid">
								...
								<div class="top-rates">
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="single."><img class="img-responsive " src="resources/images/r.jpg" alt=""></a>	
										</div>
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="single"><img class="img-responsive " src="resources/images/r1.jpg" alt=""></a>	
										</div>
										<div class="recent-right">
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="single"><img class="img-responsive " src="resources/images/r2.jpg" alt=""></a>	
										</div>
										<div class="recent-right">
											<h6 class="best2"><a href="single">Lorem ipsum dolor </a></h6>
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="single"><img class="img-responsive " src="resources/images/r3.jpg" alt=""></a>	
										</div>
										<div class="recent-right">
								...
								<div class="cat-img">
									<img class="img-responsive " src="resources/images/45.jpg" alt="">
								</div>
							</div>
							<div class="col-md-9 product-agileinfon-grid1 w3l">
								<div class="product-agileinfon-top">
									...
									<div class="col-md-6 product-agileinfon-top-left">
										<img class="img-responsive " src="resources/images/img2.jpg" alt="">
									</div>
									<div class="clearfix"></div>
								</div>
								...
								<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
									...
									<li role="presentation" class="active"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true"><img src="resources/images/menu1.png"></a></li>
									<li role="presentation"><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile"><img src="resources/images/menu.png"></a></li>
									</ul>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="resources/images/p21.jpg" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="resources/images/p22.jpg" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="resources/images/p14.jpg" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="resources/images/p13.jpg" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="resources/images/i2.jpg" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="resources/images/i1.jpg" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="resources/images/i4.jpg" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="resources/images/i3.jpg" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="resources/images/i6.jpg" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="resources/images/i5.jpg" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="resources/images/i8.jpg" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="resources/images/i7.jpg" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="resources/images/i10.jpg" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="resources/images/i9.jpg" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="resources/images/i12.jpg" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="resources/images/i11.jpg" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="resources/images/i14.jpg" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="resources/images/i13.jpg" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
